...
public class LoginController {
    ...
    private PersonalMedical currentPersonalMedical;
    @FXML
    ...
    public void loginButton() {
        ...
        if(personalMedical.isSelected() && !farmacist.isSelected() && !manager.isSelected())
        {
            ...
            try {
                ...
                currentPersonalMedical = (PersonalMedical)pers;
                OpenSectieView();
            } catch (Exception e) {
                Alert alert = new Alert(Alert.AlertType.ERROR, e.getMessage(), ButtonType.OK);
                alert.show();
    ...
    private void OpenManagerView()
    {
        ...
        Scene scene;
        try{
            scene = new Scene(loader.load(), 385, 471);
    ...
    private void OpenFarmacieView()
    {
        ...
        Scene scene;
        try{
            scene = new Scene(loader.load(), 680, 565);
    ...
    private void OpenSectieView()
    {
        ...
        Scene scene;
        try{
            scene = new Scene(loader.load(), 624, 508);
            PersonalMedicalController controller = loader.getController();
            controller.SetService(service, currentPersonalMedical);
